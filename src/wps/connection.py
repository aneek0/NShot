...
class Initialize:
    ...
    def __init__(self, interface: str, args=None):
    ...
    def singleConnection(self, bssid: str = None, pin: str = None, pbc_mode: bool = False, store_pin_on_fail: bool = False) -> bool:
        ...
        if self.ARGS.pixie_dust:
            if self.PIXIE_CREDS.getAll():
                pin = self.PIXIE_CREDS.runPixieWps(self.ARGS.show_pixie, self.ARGS.pixie_force)
                if pin:
    ...
    def _wpsConnection(self, bssid: str = None, pin: str = None,
        ...
        while True:
            ...
            if retry_on_lock and self.CONNECTION_STATUS.IS_LOCKED:
                logger.warning(f'{bssid} is WPS LOCKED. Retrying in {self.ARGS.timeout}s…')
