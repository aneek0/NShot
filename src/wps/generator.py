...
class NetworkAddress:
    ...
    def __init__(self, mac):
        if isinstance(mac, int):
            ...
            self._STR_REPR = ':'.join(cleaned[i:i + 2] for i in range(0, 12, 2)).upper()
            self._INT_REPR = int(cleaned, 16)
        else:
    ...
    def _mac2int(mac) -> int:
        ...
        return int(re.sub(r'[^0-9a-fA-F]', '', mac), 16)
...
class WPSpin:
    ...
    def _suggest(bssid: str) -> list:
        ...
        algorithms = {
            ...
            'pinTDW8960N_90F65248E173': ('90F65248E173',),
            'pinTDW8960N_90F65256': ('90F65256',),
            'pinTDW8960N_90F652DE231B': ('90F652DE231B',),
            'pinTDW8960N_F8D1117DCC54': ('F8D1117DCC54',),
            'pinTDW8961ND_90F65256935C': ('90F65256935C',),
            'pinTDW8961ND_B0487AD1CAA5': ('B0487AD1CAA5',),
            'pinTDW8961ND_B0487AD1CC79': ('B0487AD1CC79',),
            'pinTDW8961ND_B0487AD1CC9E': ('B0487AD1CC9E',),
            'pinTDW8961ND_B0487AD1CCCA': ('B0487AD1CCCA',),
            'pinTDW8961ND_B0487AD1CD68': ('B0487AD1CD68',),
            'pinTDW8961ND_B0487AD1D0EB': ('B0487AD1D0EB',),
            'pinTDW8961ND_B0487AD5E066': ('B0487AD5E066',),
            'pinTDW8961ND_B0487AD5E46D': ('B0487AD5E46D',),
            'pinTDW8961ND_B0487AD5E7A6': ('B0487AD5E7A6',),
            'pinTDW8961ND_B0487AF0B108': ('B0487AF0B108',),
            'pinTDW8961ND_B0487AF5D82B': ('B0487AF5D82B',),
            'pinTDW8961ND_F8D118F21A3': ('F8D118F21A3',),
            'pinTDW8961ND_F8D118F2DFA': ('F8D118F2DFA',),
        }
        res = []
